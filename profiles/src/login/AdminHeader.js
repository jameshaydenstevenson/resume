        ...
        {this.props.person != null &&
          ...
          >
            ...
            >
              ...
              <Menu.Item key="admin-home" className="font-500 inline-flex flex-center">
                <Tooltip title="Home" placement="bottom" mouseEnterDelay={.75}>
                <Link
                  to={'/admin/admin-home/' + this.props.person.id}>
              ...
              <Menu.Item key="schools" className="font-500 inline-flex flex-center">
                ...
                <Link
                  ...
                  <Icon type="profile" className={"font-24 va-middle flex-h-center " +
                  "mr-0 br-50 border p-1 font-30 ant-btn-primary"} />
                </Link>
                </Tooltip>
              </Menu.Item>
