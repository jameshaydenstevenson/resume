  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        values.title = 'I have a question'
    ...
    return (
      <div>
         {this.state.submitted ?
            <Alert
            message={<h2 style={{marginTop: -6}}>Question received</h2>}
            description={<div>
          ...
          <Form onSubmit={this.handleSubmit} className="login-form">
            ...
            <FormItem {...formItemLayout} label="Question" className="block-label">
              {getFieldDecorator('message', {
                rules: [{ required: true, message: 'Please input a question.' }],
              })(
                <TextArea placeholder="Your question..." autosize={{ minRows: 4 }} />
              )}
            </FormItem>
